...
def test_return_user(test_user):
    ...
    assert response.json()['username'] == "codingwithfranciscatest"
    assert response.json()['email'] == "codingwithfranciscatest@gmail.com"
    assert response.json()['first_name'] == "Francisca"
